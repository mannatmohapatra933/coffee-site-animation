          ...
          <div className="space-y-8">
            {features.filter(f => f.position === 'left').map((feature, i) => (
              <motion.div
                ...
                className="bg-[#3D2820]/60 backdrop-blur-sm p-8 rounded-xl border border-[#5A4034]/50 hover:border-[#4F9C8F]/50 transition-all duration-300 hover:bg-[#3D2820]/80"
              >
                <h3 className="text-2xl font-['playfair'] font-semibold text-[#F5E6D3] mb-4">
                  {feature.title}
                </h3>
